...
public class CarsController {
	...
	public String saveCar(@RequestBody Cars_coming c) {
		...
		Cars tosave = new Cars(c.getCarCompany(), c.getColor(), c.getPurchaseDate(), c.getOwners(), c.getTotalRunning(),
				c.getCarModel(), c.getRegno(), c.getPrice(), c.getCity(), c.getState(), c.getPinNo(), c.getPhoto(), r);
